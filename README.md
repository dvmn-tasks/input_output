...
HTML разметкой вместо `courses_ur`. Вуаля, мы решили проблемы еще до их 
...
Кроме того, часть кода удалось превратить в [чистые функции](https://devman.org/encyclopedia/clean_code/decomposition_pure_functions/), что облегчит тестирование и повторное использование.
