...
<h2>Что еще может потребоваться в скором будущем?</h2>
...
<h3>Пойдем дальше. Код другой функции:</h3>
...
def get_course_info(html):
    ...
    return course_data
<h3>Что может произойти с кодом дальше?</h3>
...
<h3>Та же функция, часть вторая, последняя:</h3>
