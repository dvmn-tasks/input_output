...
3. Если рейтинга нет — надо искать его на другом сайте.
3. В xlsx указывать не просто отсутствие рейтинга, а еще на каких сайтах искал.
...
4. от источника данных;
4. от формата вывода в файл.
